...
\begin{bnf*}
  \bnfprod{Exp} {\bnfpn{Nat} \bnfor \bnfpn{Var} \bnfor \bnfpn{Add} \bnfor \bnfpn{Let}}\\
  \bnfprod{Nat} {\bnftd{Número natural}}\\
  \bnfprod{Var} {\bnftd{Caracter o string}}\\
  \bnfprod{Add} {\bnfpn{Exp} \bnfsp \bnfts{+} \bnfsp \bnfpn{Exp}}\\
  \bnfprod{Let} {\bnfts{let} \bnfsp \bnfpn{Var} \bnfsp \bnfts{:=} \bnfsp \bnfpn{Nat} \bnfsp \bnfts{in} \bnfsp \bnfts{(} \bnfsp \bnfpn{Exp} \bnfsp \bnfts{)}}\\
\end{bnf*}
...
\centering
\inference[lit]{n : Nat}{\Gamma \vdash n}
\end{subfigure}%
...
\begin{subfigure}{0.5\linewidth}
\centering
\inference[var]{v : String}{\Gamma \vdash v}
\end{subfigure}%
...
\begin{subfigure}{0.5\linewidth}
\centering
\inference[add]{\Gamma \vdash e1 & \Gamma \vdash e2}{\Gamma \vdash e1 + e2}
\end{subfigure}%
...
\begin{subfigure}{0.5\linewidth}
\centering
\inference[let]{\Gamma \vdash e & n : Nat & v : String}{\Gamma \vdash \textbf{let} \, v := n \, \textbf{in} \, e}
\end{subfigure}%
...
\begin{subfigure}{0.5\linewidth}
\centering
\inference[lit]{n : Nat}{\vdash n : \emptyset}
\end{subfigure}%
...
\begin{subfigure}{0.5\linewidth}
\centering
\inference[var]{v : String}{\vdash v : \{v\}}
\end{subfigure}%
...
\begin{subfigure}{0.5\linewidth}
\centering
\inference[add]{\vdash e1 : \Delta1 & \vdash e2 : \Delta2}{\vdash e1 + e2 : \Delta1 \cup \Delta2 }
\end{subfigure}%
...
\begin{subfigure}{0.5\linewidth}
\centering
\inference[let]{\vdash e : \Delta & n : Nat & v : String}{\vdash \textbf{let} \, v := n \, \textbf{in} \, e : \Delta \setminus \{v\}}
\end{subfigure}%
